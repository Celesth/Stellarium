...
// @version      1.1.0
// @description  Full post dump to Discord with Hyprland-style notifications · Mobile support
// @author       Celesth
...
(function () {
  ...
  GM_addStyle(`
    ...
    .hypr-wrap {
      ...
      /* keep within screen on narrow viewports */
      max-width: calc(100vw - 24px);
    }

    /* ── Mobile: slide from bottom instead of right ── */
    @media (max-width: 480px) {
      .hypr-wrap {
        top: auto;
        bottom: 90px;      /* clear the FAB */
        right: 0;
        left: 0;
        align-items: center;
        padding: 0 12px;
    ...
    #kmn-send-btn {
      ...
      font-family: 'JetBrains Mono', monospace;
      /* mobile: bigger, easier tap target */
      -webkit-tap-highlight-color: transparent;
  ...
  function injectButton() {
    ...
    // touchend for mobile browsers that delay click events
